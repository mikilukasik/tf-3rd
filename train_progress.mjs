...
const sourceModelDirName = 'models/progressEstimatorV1_01/0.06474-e1-1653260997268';
const modelDirName = 'models/progressEstimatorV1_02';

const recordsPerDataset = 10000;
const testRecordsPerDataset = 10000;

const outUnits = 128;
const castlingIndex = 0;
const enPassantIndex = 0;
const inputLength = 12 * 5 + 2; //12 + (castlingIndex ? 1 : 0) + (enPassantIndex ? 1 : 0);
const batchSize = 500;
const maxEpochs = 250;
const patience = 1;
...
const transformRecord = (record) => {
  ...
  const xs = getXs({ fens: [prevFen1, prevFen2, prevFen3, prevFen4, fen], lmf, lmt });
