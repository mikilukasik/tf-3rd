...
const initialSourceModelDirName = 'models/rnd_nodupe_v5';
const targetModelName = 'models/rnd_nodupe_v5';
...
const filesToCopy = {
  ...
  'train.mjs': './trainIncModelNoDupes.mjs', // todo: read only once at the beginning, in case file changes during training
...
const initialLearningRate = 0.004;
const finalLearningRate = 0.000002;
const makeTrainableBelowLr = 0.00005;
