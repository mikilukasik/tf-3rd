...
import { datasetReaderV4 } from './src/scripts/utils/getMovesDatasetPgV4.mjs';
import { getXs } from './transform.js';

const initialSourceModelDirName = 'models/pg1_small_v1';
// const initialSourceModelDirName = 'models/small_tV4_mUpUbU_v2_0.000015625/2.12750387-1669639067589';
const targetModelName = 'models/small_tV4_mUpUbU_winOrPosHs';
...
const fileNamesToCopy = {
  'train.mjs': './trainV4.mjs',
  'loader.js': './dist/pg_loader.js',
  'datasetReader.mjs': './src/scripts/utils/getMovesDatasetPgV4.mjs',
  ...
  try {
    if (!alreadyInited)
      getNextDatasets = await (async () => {
        ...
        console.log('datasetReaderV4 for lessons initialized');
