...
const initialSourceModelDirName = 'models/inc4_rnd_v1';
const targetModelName = 'models/rnd_lssopn_v1';

// [wr, wf, i, p, o2, lmf, lmt, wm ? movesToOneHot[wm[0]][wm[1]] : '-', s]
const filter = (data) => data[0] === '1' && (Number(data[2]) > 25 || Math.random() < Number(data[2]) / 25); //games won, less openings to prevent overfitting

const filesToCopy = {
  'createModelInc.js': path.resolve(initialSourceModelDirName, 'createModelInc.js'),
  'train.mjs': './trainIncModelLessOpening.mjs',
  'transforms.js': 'src/lib/bundledTransforms/inc_transforms.js',
};

const recordsPerDataset = 30000;
const testRecordsPerDataset = 5000;
