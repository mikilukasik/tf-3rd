...
const initialSourceModelDirName = 'models/newest_SM_tV13-p0_v1_0.0001/1.82014370-1676159675161';
const targetModelName = 'models/newest_SM_tV13-p0_v1';
...
const initialLearningRate = 0.0001; //0.0005; //0.0001; //0.001; //0.0005; //0.0005; //0.0005; //0.000125; //0.000015625; //0.001;
