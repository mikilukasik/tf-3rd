...
const creatorFilename = 'createOMEModel.js';

const versionName = 'v1';
const modelName = 'OME_small';
...
const buildModel = function () {
  ...
  const dense1 = denseLayer({ input: concatenated, units: 192 });
  const dense2 = denseLayer({ input: dense1, units: 96 });
