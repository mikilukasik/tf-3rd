...
const layerNamePrefix = 'v13_merged_ML_ad_v1';
const targetModelDirName = `models/v13_merged_ML_ad_v2`;
...
const attachLayersToNewInputLayer = ({ layers, input, trainable = false }) => {
...
const getConcatenatedLayers = async ({ input }) => {
  ...
  const newDLayers = attachLayersToNewInputLayer({ layers: denseModel.layers, input, trainable: true });
  beforeLastLayers.push(newDLayers[newDLayers.length - 1]);
